...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT( /* Base */
        ...
        KC_TAB,   KC_A,     KC_Z,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_PGUP,    
        KC_CAPS,  KC_Q,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_M,     KC_QUOT,            KC_ENT,   KC_PGDN,          
        KC_LSFT,            KC_W,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_SCLN,  KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,    KC_END,
